<%@ Page Title="" Language="C#" MasterPageFile="~/MaAlcalde.Master" AutoEventWireup="true" CodeBehind="ReporteTipoPermisoAlcalde.aspx.cs" Inherits="GestionDePermisos.Views.Alcalde.ReporteTipoPermisoAlcalde" %>
    ...
    <script>
        function pruebaDivAPdf() {
            ...
            pdf.fromHTML(
                ...
                function (dispose) {
                    pdf.save('ReporteTipoPermiso' + Date() + '.pdf');
                }, margins
            );
        }
    </script>
