...
namespace GestionDePermisos.Views.Jefe_Interno
{
    public partial class ConsultarPermisosJeInt : System.Web.UI.Page
    {
        ...
        {
            int consultaRut = Convert.ToInt32(txtRutSolicitud.Text);
            ...
            ClientScript.RegisterStartupScript(GetType(), "Javascript", "javascript: busqueda(); ", true);
        }

        protected void btnLimpiar_Click(object sender, EventArgs e)
        {
            txtRutSolicitud.Text = string.Empty;
            ClientScript.RegisterStartupScript(GetType(),"Javascript","javascript: clean(); ",true);
        }
